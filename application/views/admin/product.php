...
<body>
											...
											<nav>
												<ul class="pagination">
													<li class="page-item <?= $current_page > 1 ? '' : 'disabled' ?>">
														<a class="page-link"
															href="/stone-store/products?page=<? $current_page - 1 ?>"
															aria-label="Previous">
													...
													<li class="page-item <?= $current_page == $i ? 'active' : '' ?>">
														<a class="page-link"
															href="/stone-store/products?page=<?= $i ?>"><?= $i ?></a>
													</li>
													<?php endfor;?>
													<li
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="addProductModal">
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				...
				<form action="/stone-store/products" method="post" enctype="multipart/form-data">
					<div class="modal-body d-flex flex-column align-items-start justify-content-center">
						<div class="row d-flex align-items-center justify-content-around w-100 mb-3">
							...
							<div id="image-preview"
								...
								<p class="text-danger d-none" id="product-image-alert"></p>
							</div>
						</div>
						<div class="d-flex flex-row align-items-start justify-content-around row w-100">
							...
							<div class="mb-3 col-5">
								...
								<textarea class="form-control" name="product_desc" id="product_desc"
									value="<?= set_value('product_desc') ?>" rows="3"></textarea>
							...
							<div class="form-group row mb-4 col-5">
								<div class="col-sm-12 col-md-7">
									<div class="image-preview">
										<label for="image-upload" class="cursor-pointer" id="image-label">Pilih Gambar
											&nbsp; <i class="fa-solid fa-image"></i></label>
										<input type="file" name="image-upload-edit" id="image-upload"
											accept="image/png, image/jpeg, image/jpg" onchange="previewImage()" />
									</div>
								</div>
							</div>
	...
	<script src="<?= base_url('assets/modules/bootstrap/js/bootstrap.bundle.js') ?>"></script>
	...
	<script src="<?= base_url('assets/modules/ckeditor5/build/ckeditor.js') ?>"></script>
	<script>
		ClassicEditor
